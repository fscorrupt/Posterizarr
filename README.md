...
> [!NOTE]
Posterizarr is cross-platform ready, meaning it can run on Linux, [Docker (Alpine v3.17 Base Image) does not work on ARM](#docker), [unRAID](#unraid) and on Windows operating systems.
> 
